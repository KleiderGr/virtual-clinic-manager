import{u as s}from"./skeleton-CUrxD645.js";import{s as t}from"./index-C9lGsgGk.js";function u(){return s({queryKey:["patients"],queryFn:async()=>{const{data:e,error:r}=await t.from("profiles").select(`
          *,
