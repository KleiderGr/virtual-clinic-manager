import{u as s}from"./skeleton-Cspd_ZVl.js";import{s as t}from"./index-BWDx30WS.js";function u(){return s({queryKey:["patients"],queryFn:async()=>{const{data:e,error:r}=await t.from("profiles").select(`
          *,
